...
#include "zinitix_touch_logan.h"
#if MULTI_PROTOCOL_TYPE_B
#include <linux/input/mt.h>
#endif

#include "./ZinitixFW_Logan/zinitix_touch_zxt_firmware(ZI02FF80).h"
#include "./ZinitixFW_Logan/zinitix_touch_zxt_firmware(ZI03221F).h"
