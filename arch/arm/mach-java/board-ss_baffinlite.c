...
#ifdef CONFIG_BACKLIGHT_KTD3102
...
#define DB8V61M_I2C_ADDRESS (0x54)
...
static struct i2c_board_info hawaii_i2c_camera[] = {
	...
	{
		I2C_BOARD_INFO("camdrv_ss_sub", DB8V61M_I2C_ADDRESS),
	},
};
...
static struct v4l2_subdev_sensor_interface_parms db8v61m_if_params = {
	.if_type = V4L2_SUBDEV_SENSOR_SERIAL,
	.if_mode = V4L2_SUBDEV_SENSOR_MODE_SERIAL_CSI2,
...
static struct soc_camera_link iclink_db8v61m = {
	.bus_id		= 0,
...
#ifdef CONFIG_BACKLIGHT_KTD3102
static struct platform_ktd_backlight_data bcm_ktd_backlight_data = {
	.max_brightness = 255,
	.dft_brightness = 160,
	.ctrl_pin = 24,
};
...
struct platform_device backlight_device = {
	...
	.id = -1,
	.dev = {
		.platform_data  =  &bcm_ktd_backlight_data,
	},
};
...
static struct i2c_board_info __initdata cyttsp4_i2c_info[]  = {
	{
		...
		.irq = gpio_to_irq(TMA46x_GPIO_TSP_INT),
...
//#ifdef CONFIG_TOUCHSCREEN_CYPRESS_TMA46X
	i2c_register_board_info(3, cyttsp4_i2c_info,
		ARRAY_SIZE(cyttsp4_i2c_info));
	pr_info("=== board_tsp_init_cyttsp4 ===\n");
	board_tsp_init_cyttsp4();
//#endif
}
