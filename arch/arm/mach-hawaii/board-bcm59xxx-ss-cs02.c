...
/* TODO regulator */
	...
	/* CS02 Xtal RTC = 14pF */
	{.addr = PMU_REG_RTC_C2C1_XOTRIM, .val = 0x33, .mask = 0xFF},
...
static struct batt_esr_temp_lut ss_cs02_esr_temp_lut[] = {
	{
		.temp = -200,
		.reset = 0, .fct = 235, .guardband = 50,
		.esr_vl_lvl = 3802, .esr_vm_lvl = 3989, .esr_vh_lvl = 4257,
		.esr_vl_slope = -10047, .esr_vl_offset = 40082,
		.esr_vm_slope = -808,  .esr_vm_offset = 4955,
		.esr_vh_slope = 1186,   .esr_vh_offset = -2998,
		.esr_vf_slope = -8211, .esr_vf_offset = 37002,
	},
	{
		.temp = -100,
		.reset = 0, .fct = 595, .guardband = 50,
		.esr_vl_lvl = 3694, .esr_vm_lvl = 3844, .esr_vh_lvl = 4200,
		.esr_vl_slope = -94657, .esr_vl_offset = 351320,
		.esr_vm_slope = -4694,   .esr_vm_offset = 19032,
		.esr_vh_slope = 965,   .esr_vh_offset = -2720,
		.esr_vf_slope = -3608,  .esr_vf_offset = 16487,
	},
	{
		.temp = 0,
		.reset = 0, .fct = 848, .guardband = 30,
		.esr_vl_lvl = 3789, .esr_vm_lvl = 4321, .esr_vh_lvl = 4335,
		.esr_vl_slope = -7686, .esr_vl_offset = 29721,
		.esr_vm_slope = -331,  .esr_vm_offset = 1855,
		.esr_vh_slope =  -2902,  .esr_vh_offset = 12964,
		.esr_vf_slope = -2902,  .esr_vf_offset = 12964,
	},
	{
		.temp = 100,
		.reset = 0, .fct = 943, .guardband = 30,
		.esr_vl_lvl = 3689, .esr_vm_lvl = 3694, .esr_vh_lvl = 4321,
		.esr_vl_slope = -4499, .esr_vl_offset = 17434,
		.esr_vm_slope = -61644,  .esr_vm_offset = 228231,
		.esr_vh_slope = -423,  .esr_vh_offset = 2105,
		.esr_vf_slope = -1472,  .esr_vf_offset = 6637,
	},
	{
		.temp = 200,
		.reset = 0, .fct = 1000, .guardband = 30,
		.esr_vl_lvl = 3689, .esr_vm_lvl = 3694, .esr_vh_lvl = 4059,
		.esr_vl_slope = -1475, .esr_vl_offset = 5750,
		.esr_vm_slope = -15019, .esr_vm_offset = 55711,
		.esr_vh_slope = 69,  .esr_vh_offset = -18,
		.esr_vf_slope = -321, .esr_vf_offset = 1565,
	},
};
